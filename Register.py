...
def open_registration_window(main_app):
    ...
    frame = ctk.CTkFrame(register_window, corner_radius=15, fg_color="cyan")  # Match splash screen color
    frame.pack(expand=True, fill="both", padx=20, pady=20)

    label_reg = ctk.CTkLabel(frame, text="Titans Fitness Club - Register", font=("Helvetica", 24, "bold"), text_color="white")
    ...
    password_suggestion_label = ctk.CTkLabel(frame, text="Suggested Password: ", font=("Helvetica", 10), text_color="white")
